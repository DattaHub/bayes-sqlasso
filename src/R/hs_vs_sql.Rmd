...
theta_smpls_hs_melt = melt(theta.smpls.hs)
theta_smpls_hs_melt = theta_smpls_hs_melt %>% filter(value > -10 & value < 30)
ggplot(theta_smpls_hs_melt, aes(value)) + geom_histogram()
```
